    ...
    <div className="grid place-items-center h-screen bg-gradient-to-b from-green-50 to-white p-4">
      <div className="shadow-xl p-8 rounded-2xl bg-white border border-gray-100 w-full max-w-md transition-all">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-extrabold text-gray-900">Daftar <span className="text-green-600">frugalin.aja</span></h1>
          <p className="text-sm text-gray-500 mt-1">Mulai kelola keuanganmu dengan lebih bijak</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="text-sm mt-4 text-center text-gray-500">
            Sudah punya akun?{" "}
            <Link className="underline font-semibold text-green-600 hover:text-green-700" href="/login">
              Login di sini
            </Link>
          </div>
        </form>
